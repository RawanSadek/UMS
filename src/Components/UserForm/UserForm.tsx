    ...
    <form onSubmit={handleSubmit(onSubmit)} className="userForm p-5 shadow-lg col-9 position-relative rounded-4">
      ...
      <div className="row justify-content-center">
        ...
        <div className="col-12 col-lg-6 mb-3">
          ...
          <input disabled={disableFlag} type="text" className='form-control px-3 py-2' placeholder={`Enter your phone`} {...register('phone', { required: 'phone is required!!!' /*, pattern:{value:/^\+?\d{1,4}[\s-]?\(?\d{2,4}\)?([\s-]?\d{2,4}){2,3}$/, message:"Invalid phone number!!"}*/})} />
